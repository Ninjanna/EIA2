namespace Eis {
    ...
    function abschicken(): void {
        console.log("bereit zum abschicken :D");
        sortenImLinkZeigen();
    ...
    function handleStateChange(_event: ProgressEvent): void {
        ...
        // die readyState variable hat viele zustände, wir brauchen den DONE, deswegen schauen wir mit der if abfrage 
        // wann done da ist
            document.getElementById("serverAntwort").innerHTML = xhr.response;
        }
    }
